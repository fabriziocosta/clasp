...
from clasp.graph.inter import build_inter_batch_graph
from clasp.graph.intra import build_intra_batch_graph
from clasp.graph.params import GraphParams
from clasp.io import validate_adata
from clasp.preprocessing import split_batches


def build_clasp_graph(
    adata: ad.AnnData,
    *,
    rep_key: str = "X_pca",
    batch_key: str = "batch",
    ...
    """Build the CLASP integrated graph for an AnnData object."""
    params = GraphParams(
